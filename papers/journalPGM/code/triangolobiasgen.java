...
public class triangolobiasgen {
    public static void main(String[] args) throws IOException {
        ...
        String wdir = ".";
        String modelfolder = "papers/journalPGM/models/literature/triangolo/";
        ...
        String output = Path.of(wdir, modelfolder, modelname.replace(".uai", "_biassoft_2.uai")).toAbsolutePath().toString();
        ...
        hidden_conf = new int[][]{{0,0},{0,1},{1,1}};   // hard bias
        ...
        output = Path.of(wdir, modelfolder, modelname.replace(".uai", "_biashard_2.uai")).toAbsolutePath().toString();
        IO.write(modelBiased, output);
