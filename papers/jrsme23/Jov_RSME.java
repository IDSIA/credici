...
public class Jov_RSME {
    public static void main(String[] args) throws InterruptedException, ExecutionControl.NotImplementedException {
        ...
        System.out.println("V-factor: "+m.toVCredal(emp1.values()));

        ((SeparateHalfspaceFactor)m.toHCredal(emp1.values()).getFactor(U)).printLinearProblem(0);
        ((SeparateHalfspaceFactor)m.toHCredal(emp2.values()).getFactor(U)).printLinearProblem(0);
