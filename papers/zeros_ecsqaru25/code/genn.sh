...
sbatch  --export=nzr=1.0,zdr=0.0,init_seed=0 -n 100 genn.sbs
sbatch  --export=nzr=0.8,zdr=0.0,init_seed=0 -n 100 genn.sbs
sbatch  --export=nzr=0.6,zdr=0.0,init_seed=0 -n 100 genn.sbs

sbatch  --export=nzr=1.0,zdr=0.5,init_seed=0 -n 100 genn.sbs
sbatch  --export=nzr=0.8,zdr=0.5,init_seed=0 -n 100 genn.sbs
sbatch  --export=nzr=0.6,zdr=0.5,init_seed=0 -n 100 genn.sbs


sbatch  --export=nzr=1.0,zdr=1.0,init_seed=0 -n 100 genn.sbs
sbatch  --export=nzr=0.8,zdr=1.0,init_seed=0 -n 100 genn.sbs
sbatch  --export=nzr=0.6,zdr=1.0,init_seed=0 -n 100 genn.sbs
...
#sbatch  --export=np=4,nzr=1.0,zdr=0.5,ys=2,init_seed=0 -n 100 genn.sbs
#sbatch  --export=np=4,nzr=0.8,zdr=0.5,ys=2,init_seed=0 -n 100 genn.sbs
#sbatch  --export=np=4,nzr=0.6,zdr=0.5,ys=2,init_seed=0 -n 100 genn.sbs
#sbatch  --export=np=4,nzr=0.4,zdr=0.5,ys=2,init_seed=0 -n 100 genn.sbs
#sbatch  --export=np=4,nzr=0.2,zdr=0.5,ys=2,init_seed=0 -n 100 genn.sbs

#sbatch  --export=np=4,nzr=1.0,zdr=1.0,ys=2,init_seed=0 -n 100 genn.sbs
#sbatch  --export=np=4,nzr=0.8,zdr=1.0,ys=2,init_seed=0 -n 100 genn.sbs
#sbatch  --export=np=4,nzr=0.6,zdr=1.0,ys=2,init_seed=0 -n 100 genn.sbs
#sbatch  --export=np=4,nzr=0.4,zdr=1.0,ys=2,init_seed=0 -n 100 genn.sbs
#sbatch  --export=np=4,nzr=0.2,zdr=1.0,ys=2,init_seed=0 -n 100 genn.sbs