...
public class TrivialFromScratch {
    public static StructuralCausalModel buildModel(){
        ...
        // define the factors
        BayesianFactor fx = BayesianFactorBuilder.deterministic(model.getDomain(x), model.getDomain(ux), 1,1,0);
        BayesianFactor pux = BayesianFactorBuilder.as(model.getDomain(ux), new double[] { 0.6, 0.2, 0.2 });
