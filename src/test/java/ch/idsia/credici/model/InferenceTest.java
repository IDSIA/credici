...
public class InferenceTest {
	...
	@Test
	public void CredalCausalVE() throws InterruptedException {
	...
	@Test
	public void CausalVE() throws InterruptedException {
		...
		/*
		 * 
		 * expected = new double[]{0.010309278350515464}; actual =
		 * inf.probNecessity(x,y).getData()[0][0];
		 * Assert.assertArrayEquals(expected,actual,0.000001);
		 * 
		 * 
		 * expected = new double[]{0.25}; actual =
		 * inf.probSufficiency(x,y).getData()[0][0];
		 * Assert.assertArrayEquals(expected,actual,0.000001);
		 */
